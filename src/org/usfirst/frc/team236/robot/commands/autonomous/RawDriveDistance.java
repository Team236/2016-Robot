 ...
 * 
 * @param _speed The speed for the robot to drive (-1 to 1)
 * @param _distance The distance for the robot to drive in inches. Must be
 * negative if the robot is going backwards
 */
